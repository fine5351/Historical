...
SELECT 1, 'Alice Smith', '123 Maple St', 'Female', 'A123456789', 'system', 'system', NOW(), NOW() FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM employee WHERE id = 1);
INSERT INTO employee (id, name, address, gender, roc_id, created_by, updated_by, created_at, updated_at)
SELECT 2, 'Bob Johnson', '456 Oak Ave', 'Male', 'B987654321', 'system', 'system', NOW(), NOW() FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM employee WHERE id = 2);
INSERT INTO employee (id, name, address, gender, roc_id, created_by, updated_by, created_at, updated_at)
SELECT 3, 'Charlie Brown', '789 Pine Ln', 'Male', 'C112233445', 'system', 'system', NOW(), NOW() FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM employee WHERE id = 3);

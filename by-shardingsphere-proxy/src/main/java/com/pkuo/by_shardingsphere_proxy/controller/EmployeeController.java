package com.pkuo.by_shardingsphere_proxy.controller;

import com.mybatisflex.core.paginate.Page;
import com.pkuo.by_shardingsphere_proxy.entity.Employee;
import com.pkuo.by_shardingsphere_proxy.mapper.EmployeeMapper;
...
public class EmployeeController {
    ...
    public Employee getEmployeeById(@PathVariable Long id) {
        return employeeMapper.selectOneByIdFromHackathon(id);
    }
